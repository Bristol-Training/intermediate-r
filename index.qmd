...
Welcome to this second course on R programming! This course builds upon Beginning R and delves deeper into working with advanced data structures, write functions, explore modules, and how to handle errors and exceptions. Get ready to take your R skills to the next level!

For the purpose of this course we will be using a free tool called JupyterLab which provides you with a local editor and R terminal in your web browser. Setting up instructions can be found [here]("pages/010-workspace-setup.qmd").
